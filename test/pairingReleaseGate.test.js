...
test("release evidence must cover every physical step and the exact artifacts", () => {
  const artifacts = { serverSha256: "server", apkSha256: "apk", fixtureSha256: "fixture",
    replicationFixtureSha256: "replication-fixture" };
  ...
  assert.throws(() => validate(report, { ...artifacts, replicationFixtureSha256: "different" }));
  assert.throws(() => validate(report, { ...artifacts, replicationFixtureSha256: undefined }));
