...
- [X] T028 Run `npm run check`, `npm test`, web build, artifact verification and OpenAPI consistency on the candidate; record exact results and open release gates in `docs/REPLICATION_V2_ACCEPTANCE.md` (SC-001–006).
...
- [ ] T032 [US2] Extract key-grant paging and degraded retry coordination into `web/src/lib/sync/key-sync.ts` with independent cursor tests (FR-005–006).
