...
- [ ] T006 [US1] Add immutable snapshot session state, baseline, expiry and keyset page reads in `src/eventStore.js` (FR-004).
- [ ] T007 [US1] Add additive snapshot V2 endpoints and authorization in `src/controlPlaneRoutes.js` and `src/server.js`, bump `package.json`, regenerate `docs/openapi.json`, and update `docs/INTEGRATION.md` (FR-004, FR-010).
