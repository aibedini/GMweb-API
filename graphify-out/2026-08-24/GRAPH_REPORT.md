# Graph Report - GoogleMEssage  (2026-08-24)

## Corpus Check
- 85 files · ~88,041 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1497 nodes · 4281 edges · 97 communities (80 shown, 17 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 525 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `672686e9`
...
2. `r()` - 93 edges
3. `n()` - 91 edges
4. `GoogleMessagesClient` - 89 edges
5. `t()` - 88 edges
6. `a()` - 74 edges
7. `s()` - 55 edges
8. `o()` - 51 edges
...
### Community 2 - "wc"
Cohesion: 0.15
Nodes (28): ao(), componentDidMount(), ec(), el(), ff(), gl(), hf(), hl() (+20 more)

### Community 3 - "server.js"
Cohesion: 0.03
Nodes (60): activeSendCancellationRequests, ADMIN_ONLY_PREFIXES, { AndroidGatewayClient }, ANNOUNCEMENT_PENDING_LIMIT, { ApiKeyStore }, authFailBuckets, backfillPendingLedger(), browserRecoveryFile (+52 more)
...
Cohesion: 0.10
Nodes (21): { chromium }, { EventEmitter }, fs, normalizeComparableMessage(), path, sendGate(), sendSchedule(), zonedClock() (+13 more)
...
Cohesion: 0.26
Nodes (16): deferConversationJob(), deferPowerOffJob(), deferQuietHoursJob(), emitSse(), handleSendCompleted(), isBrowserAutomationWedge(), isDelayedRetryJob(), isPairingReadinessFailure() (+8 more)

### Community 20 - "index-C7h9QJI0.js"
Cohesion: 0.03
Nodes (53): animation(), Bi(), br(), bt(), cm(), dd(), duration(), end() (+45 more)

### Community 21 - "r"
Cohesion: 0.12
Nodes (38): ae(), b(), bindToMotionValue(), createPanHandlers(), ct(), r(), em(), i() (+30 more)

### Community 22 - "gp"
Cohesion: 0.20
Nodes (25): E(), gp(), ae(), ce(), k(), oe(), se(), im() (+17 more)
...
### Community 25 - "then"
Cohesion: 0.10
Nodes (27): Bl(), Bo(), Cu(), ds(), Fl(), getBaseTarget(), getBaseTargetFromProps(), getDefaultTransition() (+19 more)

### Community 26 - "readValue"
Cohesion: 0.18
Nodes (12): gf(), Gt(), nt(), Pt(), readValue(), readValueFromInstance(), setBaseTarget(), sn() (+4 more)

### Community 27 - "c"
Cohesion: 0.15
Nodes (34): Bd(), Ce(), D(), ee(), es(), ie(), ip(), c() (+26 more)
...
### Community 29 - "start"
Cohesion: 0.21
Nodes (20): cancel(), clearAnimation(), clearListeners(), commitStyles(), destroy(), dirty(), endPanSession(), getAxisMotionValue() (+12 more)

### Community 30 - "la"
Cohesion: 0.12
Nodes (29): attach(), ci(), Da(), Fa(), fi(), getVelocity(), gi(), hi() (+21 more)

### Community 31 - "fs"
Cohesion: 0.13
Nodes (24): addValue(), as(), complete(), fs(), getStaticValue(), getValue(), Go(), hasValue() (+16 more)
...
### Community 34 - "a"
Cohesion: 0.14
Nodes (29): af(), Bf(), cl(), Dl(), Ef(), Id(), If(), jf() (+21 more)

### Community 35 - "bu"
Cohesion: 0.15
Nodes (19): at(), bu(), cp(), dp(), Du(), fp(), it(), onPointerDown() (+11 more)
...
### Community 38 - "react"
Cohesion: 0.10
Nodes (7): NAV, Input, Label, Textarea, SseEvent, SendPage(), react
...
### Community 43 - "kd"
Cohesion: 0.13
Nodes (27): Aa(), Ad(), ar(), cr(), et(), getGeneratorVelocity(), gn(), gr() (+19 more)

### Community 44 - "i"
Cohesion: 0.18
Nodes (27): Ac(), addListeners(), bc(), C(), cc(), cf(), ea(), Eu() (+19 more)

### Community 45 - "s"
Cohesion: 0.18
Nodes (26): Al(), Au(), cd(), ei(), fd(), Fu(), Gu(), s() (+18 more)
...
### Community 47 - "uc"
Cohesion: 0.18
Nodes (24): ba(), co(), dc(), di(), ed(), fc(), ge(), hc() (+16 more)
...
### Community 58 - "AndroidGatewayClient"
Cohesion: 0.12
Nodes (5): AndroidGatewayClient, { AndroidGatewayClient }, assert, http, test
...
### Community 69 - "Controls.tsx"
Cohesion: 0.40
Nodes (3): ACTIONS, ControlsPage(), PowerResponse
...
### Community 74 - "is"
Cohesion: 0.14
Nodes (23): bs(), build(), ca(), cs(), gd(), gs(), Ho(), hs() (+15 more)

### Community 75 - "add"
Cohesion: 0.14
Nodes (15): add(), addVariantChild(), clear(), Ft(), getClosestVariantNode(), handleChildMotionValue(), i(), Kt() (+7 more)

### Community 80 - "constructor"
Cohesion: 0.31
Nodes (10): attachTimeline(), constructor(), Dr(), initAnimation(), onKeyframesResolved(), ot(), play(), st() (+2 more)

### Community 90 - "ma"
Cohesion: 0.22
Nodes (10): df(), Do(), fo(), ga(), ha(), ma(), Po(), rt() (+2 more)

### Community 91 - "forEach"
Cohesion: 0.32
Nodes (8): ai(), ap(), forEach(), ki(), kp(), resolveRefConstraints(), Ua(), Wa()

### Community 92 - "qc"
Cohesion: 0.29
Nodes (8): componentDidUpdate(), componentWillUnmount(), getSnapshotBeforeUpdate(), promote(), qc(), relegate(), remove(), safeToRemove()

### Community 93 - "bn"
Cohesion: 0.29
Nodes (7): bn(), t(), en(), Fn(), In(), vn(), yn()
