"""502 diagnosis: service state + journal crash reason."""
import sys
import paramiko
...
REMOTE = r'''
systemctl is-active gmweb-api || true
journalctl -u gmweb-api -n 25 --no-pager | grep -E "Error|error|at |Sqlite|Fastify|FATAL" | head -10
'''
